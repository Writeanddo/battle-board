...
public class NewgroundsUtility : MonoBehaviour
{
    ...
    /// <summary>
    /// Unlocks the medal with the provided id.
    /// </summary>
    /// <param name="id">The id of the medal.</param>
    public void UnlockMedal(int id)
    {
        // Don't proceed if we've already unlocked this medal
    ...
    /// <summary>
    /// Posts a score to the provided scoreboard.
    /// </summary>
    /// <param name="id">The id of the scoreboard.</param>
